...
```
├── data/
│   ├── raw/              #  (EPC 2025, IMD 2019, LSOA boundaries)
│   └── processed/        # Cleaned and aggregated datasets (generated by the notebook)
├── outputs/
│   ├── figures/          # Final spatial and non-spatial visualisations
